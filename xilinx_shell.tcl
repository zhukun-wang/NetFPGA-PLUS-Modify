...
if {[string match $board_name "au280"]} {
	source "$::env(NFPLUS_FOLDER)/hw/lib/xilinx/xilinx_shell_v1_0_0/open-nic-shell/src/cmac_subsystem/vivado_ip/cmac_usplus_0_au280.tcl"
...
if {[string match $board_name "au280"]} {
	source "$::env(NFPLUS_FOLDER)/hw/lib/xilinx/xilinx_shell_v1_0_0/open-nic-shell/src/cmac_subsystem/vivado_ip/cmac_usplus_1_au280.tcl"
} elseif {[string match $board_name "au250"]} {
...
if {[string match $board_name "au280"]} {
	source "$::env(NFPLUS_FOLDER)/hw/lib/xilinx/xilinx_shell_v1_0_0/open-nic-shell/src/qdma_subsystem/vivado_ip/qdma_no_sriov_au280.tcl"
} elseif {[string match $board_name "au250"]} {
